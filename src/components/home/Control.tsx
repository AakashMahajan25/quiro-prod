              ...
              <div className="sm:flex sm:gap-[9px] lg:gap-[8.68px]">
                ...
                <div className="hidden sm:block relative rounded-[6px] lg:rounded-[10px] overflow-hidden h-[120px] lg:h-[184px] 3xl:h-auto  min-h-[120px] sm:w-[26%]">
                  ...
                  <div className="relative z-10 pt-[6px] lg:pt-[10px]  pl-[4px] lg:pl-[10px] pr-[10px]">
                    <div className="text-[8px]  lg:text-[10px] 3xl:text-[13px] leading-[8px] lg:leading-[10.45px] font-[500] rounded-[6px] py-[2px] px-[6px]  flex items-center gap-2 bg-[#F5F3ED] lg:py-[2px] 3xl:py-[4px] lg:pr-[14px] lg:px-[12.86px] 3xl:px-[16px] justify-between lg:mb-[177px]">
                      Qr Based Ordering
                      <Link href="/customers">
